...
@section('content')
    <div class="row">
        <div class="col-lg-6 offset-lg-3 col-sm-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Создать Партнера</h4>
                    ...
                    <form method="POST" action="{{ route('partners.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="partner-commission" class="form-label">Комиссия</label>
                                    <input type="number"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('is_active') is-invalid @enderror"
                                            name="is_active">
                                        <option value="1" {{ old('is_active', 1) == 1 ? 'selected' : '' }}>Актив</option>
                                        <option value="0" {{ old('is_active', 1) == 0 ? 'selected' : '' }}>Отключено</option>
                                    </select>
                                    @error('is_active')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('auto') is-invalid @enderror"
                                            id="partner-auto"
                                            name="auto">
                                        <option value="1" {{ old('auto', 0) == 1 ? 'selected' : '' }}>Актив</option>
                                        <option value="0" {{ old('auto', 0) == 0 ? 'selected' : '' }}>Отключено</option>
                                    </select>
                                    @error('auto')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
