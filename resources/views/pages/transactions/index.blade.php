            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    @can('Экспорт транзакций')
                        <a href="{{ route('transactions.download',request()->all())}}" class="btn btn-success btn-sm">
                ...
                <div class="card-header">
                    <h5 class="card-title pb-2">
                        Поиск <sup class="badge badge-soft-primary"
                                   style="margin-right: 15px">{{ number_format($transactions->total()) }}</sup>
                    </h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-2">
                                <div class="btn-group mt-4" role="group">
                                    ...
                                    <a href="{{ route('transactions.index') }}" class="btn-rounded btn btn-secondary">
                                        <i class="fas fa-sync font-size-14"></i>
                                        Очистить
                                    </a>
                                </div>
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            @else
                                                @can('Отмена транзакции')
                                                    <form action="{{ route('transactions.cancel', $transaction->ext) }}"
                                                          method="post">
                                                        @csrf
