...
@section('content')
    <div class="row">
        <div class="col-lg-6 offset-lg-3 col-sm-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Обновить мерчанта</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       name="sv_terminal"
                                       value="{{ old('sv_terminal', $merchant->sv_terminal) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       name="humo_terminal"
                                       value="{{ old('humo_terminal', $merchant->humo_terminal) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('auto') is-invalid @enderror" name="auto">
                                    <option value="1" {{ old('auto', $merchant->auto) == 1 ? 'selected' : '' }}>Актив</option>
                                    <option value="0" {{ old('auto', $merchant->auto) == 0 ? 'selected' : '' }}>Отключено</option>
                                </select>
                                @error('auto')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number"
                                       ...
                                       name="limit"
                                       value="{{ old('limit', $merchant->limit) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="strict-mode" name="is_strict">
                                    <option value="0" {{ old('is_strict', $merchant->is_strict) == 0 ? 'selected' : '' }}>Нестрогий
                                    </option>
                                    <option value="1" {{ old('is_strict', $merchant->is_strict) == 1 ? 'selected' : '' }}>Строгий</option>
                                </select>
                            </div>
                            @if(auth()->user()->is_admin)
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                           ...
                                           name="sv_commission"
                                           value="{{ old('sv_commission', $merchant->sv_commission) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('humo_commission', $merchant->humo_commission) }}"
                                           placeholder="Введите комиссию">
